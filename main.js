...
function handleMoveMouseOrTouch(e){
...
function handletouchDown(e) {
  ...
  if(pickerPosition > pickColorCanvas.offsetLeft + minPickerPosition &&
    ...
    pickColorCanvas.removeEventListener('touchmove', handletouchDown);
  }
...
picker_selectedBar.addEventListener ('touchstart',(e) => {
  downTouch = true;
  if(downTouch){
    pickColorCanvas.addEventListener('touchmove', handletouchDown);
  }
  picker_selectedBar.addEventListener ('touchend',(e) => downTouch = false);
});

picker_selectedBar.addEventListener ('touchend',(e) => {
  pickColorCanvas.removeEventListener('touchmove', handletouchDown);
});
